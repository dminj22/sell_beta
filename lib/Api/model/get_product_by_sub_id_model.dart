...
//
//     final getProductBySubIdModel = getProductBySubIdModelFromJson(jsonString);

import 'dart:convert';

GetProductBySubIdModel getProductBySubIdModelFromJson(String str) => GetProductBySubIdModel.fromJson(json.decode(str));

String getProductBySubIdModelToJson(GetProductBySubIdModel data) => json.encode(data.toJson());

class GetProductBySubIdModel {
  GetProductBySubIdModel({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory GetProductBySubIdModel.fromJson(Map<String, dynamic> json) => GetProductBySubIdModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    salesCurrency: json["sales_currency"] == null ? null : json["sales_currency"],
    purchaseCurrency: json["purchase_currency"],
    shippingCurrency: json["shipping_currency"] == null ? null : json["shipping_currency"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "sales_currency": salesCurrency == null ? null : salesCurrency,
    "purchase_currency": purchaseCurrency,
    "shipping_currency": shippingCurrency == null ? null : shippingCurrency,
